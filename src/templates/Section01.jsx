...
// Component
export const Section01 = ({ title, content, coverImage }) => {
  return (
    <StyledSection01>
      <StyledFrame1>
        <StyledVelkommenText>{title || "Velkommen til København."}</StyledVelkommenText>
        <StyledFrame2>
          <StyledQuoteText>
            {content || "Sometimes, a quiet city offers the best kind of reset."}
          </StyledQuoteText>
          <StyledTaglineText>ARTS & CULTURE, DESIGN</StyledTaglineText>
        </StyledFrame2>
      </StyledFrame1>
      <StyledImage src={coverImage || "https://placehold.co/550x800"} alt="Cover" />
    </StyledSection01>
  );
};
